...
class RdvC {
    ...
    function afficherRDVs()
    {
        ...
        $sql="SElECT d.ID_RDV,d.NOW_RDV,d.DATE_RDV,d.OBJET_RDV,d.ETAT_RDV,u.nom,u.prenom FROM rdv d INNER JOIN membres u ON u.cin=d.USER_ID ORDER BY NOW_RDV DESC";
        $db = config::getConnexion();
        try{
            $liste=$db->query($sql);
            return $liste;
