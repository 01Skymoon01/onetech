                ...
                <ul class="metismenu" id="menu1">
                    <li class="active">
                        ...
                        <ul class="submenu-angle" aria-expanded="true">
                            ...
                            <li><a title="Analytics" href="statistiques.php"><span class="mini-sub-pro">Analytics</span></a></li>
                                ...
                                <div class="col-lg-6 col-md-7 col-sm-6 col-xs-12">
                                    <div class="header-top-menu tabl-d-n">
                                        <div class="breadcome-heading">
                                            <form role="search" class="" method="POST" action="http://localhost:1234/Produits/Views/rechercher_produit.php">
                                                <input type="text" placeholder="Search..." class="form-control" name="barre_recher" id="barre_recher">
